...
%First, we observe that for there to exist a cone morphism $a$ from another cone $(C, c_{\dot})$ to $Z$ we must have $|C|\geq |Z|$.  This is because $c_{\dot}(C) = (a\fcmp z_{\dot})(C)$
